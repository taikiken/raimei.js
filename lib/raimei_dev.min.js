...
(function(b){b=b.RAIMEI;var a=b.EventDispatcher;b.BufferLoader=function(){function c(a,c){this._context=a;this._url=c}var b=c.prototype;a.initialize(b);b.load=function(){var a=this._context,c=this._url,b=this,e;e=new XMLHttpRequest;e.responseType="arraybuffer";e.onload=function(){a.decodeAudioData(e.response,function(g){g?b.dispatchEvent({type:"load",buffer:g,context:a,currentTarget:e}):b.dispatchEvent({type:"error",error:Error("error decoding file data: "+c),currentTarget:e})},function(a){b.dispatchEvent({type:"error",
error:Error("decode error: "+c+", error: "+a),currentTarget:e})})};e.onerror=function(){b.dispatchEvent({type:"error",error:Error("file not found: "+c),currentTarget:e})};e.open("GET",c,!0);e.send(null)};return c}()})(window);
